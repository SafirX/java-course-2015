...
public class TulostajaTest {
    ...
    @Test
    public void lisaTestiTulostaKahdesti() throws Throwable {
        MockInOut io = new MockInOut("");
        ...
        classRef.method(o, "tulostaRivitJoilla").returningVoid().taking(String.class).invoke("sana");
        classRef.method(o, "tulostaRivitJoilla").returningVoid().taking(String.class).invoke("koe");

        String out = io.getOutput();

        assertEquals("Kutsuttiin t.tulostaRivitJoilla(\"sana\");\nt.tulostaRivitJoilla(\"koe\"); kun tiedoston sisältö oli\n"
                + "----\n"
                + "sana 1\nsana 2\nkoe\n"
                + "----\n"
                + "Olisi pitänyt tulostaa 3 riviä. Tuloste oli\n" + out, 3, out.split("\n").length);

        assertTrue("Kutsuttiin t.tulostaRivitJoilla(\"sana\");\nt.tulostaRivitJoilla(\"koe\"); kun tiedoston sisältö oli\n"
                + "----\n"
                + "sana 1\nsana 2\nkoe\n"
                + "----\n"
                + "Ensimmäisen tulostetun rivin olisi pitänyt olla \"sana1\n. \n"
        ...
        assertTrue("Kutsuttiin t.tulostaRivitJoilla(\"sana\");\nt.tulostaRivitJoilla(\"koe\"); kun tiedoston sisältö oli\n"
                ...
                + "sana 1\nsana 2\nkoe\n"
                + "----\n"
                + "Viimeisen tulostetun rivin olisi pitänyt olla \"koe\n. \n"
                + "Tuloste oli\n" + out, out.split("\n")[2].contains("koe"));
    }
