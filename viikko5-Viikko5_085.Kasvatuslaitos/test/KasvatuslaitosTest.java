...
public class KasvatuslaitosTest {
    ...
    @Points("85.1")
    @Test
    public void henkiloLuokkaKoskematon() {
        Henkilo henkilo = new Henkilo("Teppo", 17, 20, 30);
        assertEquals("Ethän muuta Henkilo luokan koodia", 20, henkilo.getPituus());
        assertEquals("Ethän muuta Henkilo luokan koodia", 30, henkilo.getPaino());
        assertFalse("Ethän muuta Henkilo luokan koodia", henkilo.taysiIkainen());
        assertEquals("Ethän muuta Henkilo luokan koodia", "Teppo", henkilo.getNimi());

        henkilo.vanhene();
        assertTrue("Ethän muuta Henkilo luokan koodia. Metodi vanhene()", henkilo.taysiIkainen());

        henkilo.setPaino(60);
        assertEquals("Ethän muuta Henkilo luokan koodia. Metodi setPaino()", 60, henkilo.getPaino());

        henkilo.setPituus(170);
        assertEquals("Ethän muuta Henkilo luokan koodia. Metodi setPituus()", 170, henkilo.getPituus());

        assertEquals("Ethän muuta Henkilo luokan koodia. Metodi painoindeksi()", 20.76, henkilo.painoindeksi(), 0.01);
    }
